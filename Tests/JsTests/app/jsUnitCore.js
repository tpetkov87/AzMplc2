...
function assertEquals() {
    ...
    if ((var1 instanceof Date) && (var2 instanceof Date))
		_assert(commentArg(2, arguments), var1.getTime() === var2.getTime(), 'Expected ' + _displayStringForValue(var1) + ' but was ' + _displayStringForValue(var2));
    else
...
function assertNotNull() {
    _validateArguments(1, arguments);
    var aVar = nonCommentArg(1, 1, arguments);
    return _assert(commentArg(1, arguments), aVar !== null, 'Expected not to be ' + _displayStringForValue(null));
}
