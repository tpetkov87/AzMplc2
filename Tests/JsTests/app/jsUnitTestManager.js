...
jsUnitTestManager.prototype.executeTestFunction = function (functionName) {
    ...
    if (!window.funcs)
		window.funcs = [];
    if (window.funcs[this._testFunctionName + this._testFileName])
		alert(this._testFileName + ":" + this._testFunctionName + " is duplicate");
    else
		window.funcs[this._testFunctionName + this._testFileName] = true;
